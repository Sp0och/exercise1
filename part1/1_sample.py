...
Usage:
(with aliasing):
python 1_sample.py --in ../images/bricks.jpg --out bricks_out_aliasing.png --factor 3

(with no aliasing using a low pass filter):
python 1_sample.py --in ../images/bricks.jpg --out bricks_out_antialiasing.png --factor 3 --sigma 1.5
"""
